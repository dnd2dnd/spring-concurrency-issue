...
import static com.project.product.domain.QProduct.product;
...
public class ProductRepositoryImpl implements ProductRepositoryCustom {
    ...
    @Override
    public List<ProductResponse> findAllBySearch(ProductCategory category, ProductOrder productOrder, Order order, String search) {
