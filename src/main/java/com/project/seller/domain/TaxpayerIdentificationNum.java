...
public class TaxpayerIdentificationNum implements Serializable {
	...
	private static final Pattern TAXPAYER_IDENTIFICATION_NUM_PATTERN = Pattern.compile(
		TAXPAYER_IDENTIFICATION_NUM_REGEX);
